...
function validarSolicitacao(funcionario, periodos, abonoPecuniarioDias, opcoes13) {
  ...
  // § único): só pode ser vinculada a UM dos períodos escolhidos. Este sistema apenas registra a
  // preferência do funcionário na programação — o requerimento formal e o lançamento oficial junto
  // ao prazo legal (janeiro do ano correspondente) ficam a cargo do RH.
  if (adiantar13) {
